...
namespace dbHandler
{
    ...
    public class DataReceivedEventArgs : EventArgs
    {
        ...
        public char StreamChar;

        /// <summary>
        /// Constructor
        /// </summary>
        /// <param name="text">The text that was received for this event to be triggered.</param>
        /// <param name="streamChar">A char representing which stream generated the event, 'o' for StdOut and 'e' for StdErr.</param>
        public DataReceivedEventArgs(string text, char streamChar)
        {
            Text = text;
    ...
    public class ProcessCaller : AsyncOperation
    {
        ...
        protected virtual void ReadStdOut()
        {
            ...
            {
                FireAsync(StdOutReceived, this, new DataReceivedEventArgs(str, 'o'));
            }
        }
        ...
        protected virtual void ReadStdErr()
        {
            ...
            {
                FireAsync(StdErrReceived, this, new DataReceivedEventArgs(str, 'e'));
            }
        }
